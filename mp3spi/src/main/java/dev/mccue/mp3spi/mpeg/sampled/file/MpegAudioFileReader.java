 ...
 *----------------------------------------------------------------------
 */
package dev.mccue.mp3spi.mpeg.sampled.file;
...
import dev.mccue.mp3spi.mpeg.sampled.file.tag.IcyInputStream;
import dev.mccue.mp3spi.mpeg.sampled.file.tag.MP3Tag;
import dev.mccue.tritonus.share.TDebug;
import dev.mccue.tritonus.share.sampled.file.TAudioFileReader;
...
public class MpegAudioFileReader extends TAudioFileReader
{
    ...
    public AudioFileFormat getAudioFileFormat(InputStream inputStream, long mediaLength) throws UnsupportedAudioFileException, IOException
    {
        ...
        try
        {
            ...
            aff_properties.put("mp3.header.pos", streamPos);
