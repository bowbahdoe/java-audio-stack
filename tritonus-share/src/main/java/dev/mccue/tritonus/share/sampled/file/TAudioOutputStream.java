...
package dev.mccue.tritonus.share.sampled.file;
...
import static dev.mccue.tritonus.share.sampled.TConversionTool.convertSign8;
import static dev.mccue.tritonus.share.sampled.TConversionTool.swapOrder16;
import static dev.mccue.tritonus.share.sampled.TConversionTool.swapOrder24;
import static dev.mccue.tritonus.share.sampled.TConversionTool.swapOrder32;

import dev.mccue.tritonus.share.TDebug;
import dev.mccue.tritonus.share.sampled.AudioUtils;
import dev.mccue.tritonus.share.sampled.TConversionTool;
...
implements AudioOutputStream
{
	...
	private void handleImplicitConversions(byte[] abData, int nOffset, int nLength) {
		...
		if (m_doEndianConversion) {
			...
			case 16: TConversionTool.swapOrder16(abData, nOffset, nLength / 2);
				break;
			case 24: TConversionTool.swapOrder24(abData, nOffset, nLength / 3);
				break;
			case 32:
